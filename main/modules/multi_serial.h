...
class MultiSerial;
using MultiSerial_ptr = std::shared_ptr<MultiSerial>;
using ConstMultiSerial_ptr = std::shared_ptr<const MultiSerial>;

class MultiSerial : public Module {
public:
    ...
    MultiSerial(const std::string name,
